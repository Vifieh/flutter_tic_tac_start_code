...
//TODO : step 34 - Create 2 enum BoardState with Done , Play as properties and GameMode with Solo , Multi as properties


class BoardService {
  BehaviorSubject<List<List<String>>> _board$;
  BehaviorSubject<List<List<String>>> get board$ => _board$;
  //TODO: step 35 - Create _player$  BehaviorSubject<String>to create  A broadcast StreamController that caches the latest added value or error.Returns a string representation of this object and use get method to get from player$
  //TODO : step 36  - Optional for the Experts delete all this lines of coding and try to make your own after you read it first for beginners and others try read all code and understand it clearly
